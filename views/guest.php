            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="service-item">
                        <div class="icon">
                            <img src="<?php echo base_url(); ?>/assets/img/service_icon_01.png" alt="">
                        </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="service-item">
                        <div class="icon">
                            <img src="<?php echo base_url(); ?>/assets/img/service_icon_02.png" alt="">
                        </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="service-item">
                        <div class="icon">
                            <img src="<?php echo base_url(); ?>/assets/img/service_icon_03.png" alt="">
                        </div>
                        <h4>Quick Support</h4>
                        <div class="line-dec"></div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="service-item">
                        <div class="icon">
                            <img src="<?php echo base_url(); ?>/assets/img/service_icon_04.png" alt="">
                        </div>
                            ...
                            <div class="projects-holder">
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 project-item mix nature">
                                      <div class="thumb">
                                            <div class="image">
                                                <a href="<?php echo base_url(); ?>/assets/img/portfolio_item_01.jpg" data-lightbox="image-1"><img src="<?php echo base_url(); ?>/assets/img/portfolio_item_01.jpg"/></a>
                                            </div>
                                      </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 project-item mix animation">
                                      <div class="thumb">
                                        <div class="image">
                                                <a href="<?php echo base_url(); ?>/assets/img/portfolio_item_02.jpg" data-lightbox="image-1"><img src="<?php echo base_url(); ?>/assets/img/portfolio_item_02.jpg"/></a>
                                            </div>
                                      </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 project-item mix branding">
                                      <div class="thumb">
                                            <div class="image">
                                                <a href="<?php echo base_url(); ?>/assets/img/portfolio_big_item_03.jpg" data-lightbox="image-1"><img src="<?php echo base_url(); ?>/assets/img/portfolio_item_03.jpg"></a>
                                            </div>
                                      </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 project-item mix graphic nature">
                                        <div class="thumb">
                                            <div class="image">
                                                <a href="<?php echo base_url(); ?>/assets/img/portfolio_big_item_04.jpg" data-lightbox="image-1"><img src="<?php echo base_url(); ?>/assets/img/portfolio_item_04.jpg"></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 project-item mix branding">
                                      <div class="thumb">
                                            <div class="image">
                                                <a href="<?php echo base_url(); ?>/assets/img/portfolio_big_item_05.jpg" data-lightbox="image-1"><img src="<?php echo base_url(); ?>/assets/img/portfolio_item_05.jpg"></a>
                                            </div>
                                      </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 project-item mix graphic animation">
                                        <div class="thumb">
                                            <div class="image">
                                                <a href="<?php echo base_url(); ?>/assets/img/portfolio_big_item_06.jpg" data-lightbox="image-1"><img src="img/portfolio_item_06.jpg"></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
